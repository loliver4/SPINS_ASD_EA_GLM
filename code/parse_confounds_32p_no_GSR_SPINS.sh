...
#SBATCH --output=/projects/loliver/SPINS_ASD_EA_GLM/data/SPINS/logs/parse_confounds_32p_no_GSR_SPINS_%j.txt
...
sub_id="sub-`index`"
python3 /projects/loliver/SPINS_ASD_EA_GLM/code/parse_confounds_32p_no_GSR.py ${sub_indir}/${sub_id}/ses-0*/func "`index`" ${sub_outdir}/${sub_id}/
